...
import static com.caowj.lib_utils.file.IOUtil.EOF;

import com.caowj.lib_utils.file.input.ClosedInputStream;
...
public class ByteArrayOutputStream extends OutputStream {
     ...
     * copy of byte[].<br> This method buffers the input internally, so there is no need to use a
    ...
    public static InputStream toBufferedInputStream(final InputStream input, final int size)
        ...
        @SuppressWarnings("resource") final ByteArrayOutputStream output = new ByteArrayOutputStream(
            size);
        output.write(input);
    ...
    /**
     * Closing a {@code ByteArrayOutputStream} has no effect. The methods in this class can be
    ...
    /**
     * Gets the current contents of this byte stream as a string using the platform default
     * charset.
     *
     ...
     *
     * @param enc the type of the character encoding
