...
import com.caowj.banner.Indicator.Companion.COLOR_INDICATOR
import com.caowj.banner.Indicator.Companion.COLOR_INDICATOR_FOCUSED
import com.caowj.banner.anim.AnimHandler
...
class AutoBanner : FrameLayout {
    ...
    internal val mBannerSwitcher: BannerSwitcher by lazy { BannerSwitcher(context) }
    internal val mIndicator: Indicator by lazy { Indicator(context) }
