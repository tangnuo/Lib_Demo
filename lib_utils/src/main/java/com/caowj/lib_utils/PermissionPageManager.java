...
public class PermissionPageManager {
    ...
    // requestcode 不能大于16bit
    public static final int SETTING_REQUEST_CODE = 0xffff - 2;

    public PermissionPageManager(Activity context) {
    ...
    private void goLGManager() {
        try {
            ...
            mContext.startActivityForResult(intent, SETTING_REQUEST_CODE);
        } catch (Exception e) {
            e.printStackTrace();
            goIntentSetting();
        }
